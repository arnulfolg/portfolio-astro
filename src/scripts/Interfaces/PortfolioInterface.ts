...
export interface Fields {
  ...
  gallery?: (GalleryEntityOrTumbnailOrSummaryPictureOrIaPictureOrAssetEntity)[] | null;
  takeaway: string;
}
...
export interface Includes {
  Asset?: (GalleryEntityOrTumbnailOrSummaryPictureOrIaPictureOrAssetEntity)[] | null;
}
