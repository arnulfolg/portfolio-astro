const userDarkDefaults = window.matchMedia('(prefers-color-scheme: dark)').matches;
	...
	const buttonLight = document.querySelector('button#toggleLight') as HTMLButtonElement;
	const buttonDark = document.querySelector('button#toggleDark') as HTMLButtonElement;
	const buttonSystem = document.querySelector('button#toggleSystem') as HTMLButtonElement;
